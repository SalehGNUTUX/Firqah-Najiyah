...
- **التالي (جارٍ الآن):** التحزيم (packaging) والتجربة الفعلية (تثبيت وتشغيل على محاكي/جهاز) **قبل** أي رفع/تحديث إضافي — أي تعديلات في هذه المرحلة تبقى محلية حتى تُختبَر وتُقَرّ. لم يُختبَر التطبيق بصرياً على الإطلاق بعد (البناء فقط تحقَّق حتى الآن)؛ هذا أول اختبار تشغيلي فعلي.
